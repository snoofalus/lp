...
def main():
    ...
    val_meter = validate(eval_loader, model, global_step, args.start_epoch, isMT = args.isMT)
    prec1=val_meter['top1'].avg
    prec3=val_meter['top3'].avg
    if args.isMT:
        ema_val_meter  = validate(eval_loader, ema_model, global_step, args.start_epoch, isMT = args.isMT)
